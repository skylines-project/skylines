<% from babel.dates import format_date %>\
{
  ...
  % for flight in flights:
    [
     ...
     "<a href=\"/flights/id/${flight.id}/\">Show</a> <span class=\"pin\" style=\"display: none;\" rel=\"tooltip\" title=\"Activate this to show the flight on top of other flights on the map\">${flight.id}</span>"]\
     % if loop.last != True:
     ,
     % endif
  % endfor
