<% from babel.dates import format_date %>\
{
  ...
  % for flight in flights:
    [
     ...
     "<a href=\"/flights/${flight.id}/\" class=\"btn btn-mini\">Show</a> <a class=\"pin no-link\" style=\"visibility: hidden;\" rel=\"tooltip\" title=\"Activate this to show the flight on top of other flights on the map\">${flight.id}</span>"]\
     % if loop.last != True:
     ,
     % endif
  % endfor
