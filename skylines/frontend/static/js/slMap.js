...
/**
 * Fit a extent to a padded view
 * Mostly a copy of ol.View.prototype.fitGeometry
 * Doesn't work with rotated views...
 *
 * @export
 * @param {ol.Extent} extent Extent.
 * @param {ol.Size} size Box pixel size.
 * @param {Array<Number>} padding Padding [top, right, bottom, left]
 */
slMap.prototype.fitExtentPadded = function(extent, size, padding) {
  ...
  var constrainedResolution = view.constrainResolution(resolution, 0, 0);
  ...
  centerX += (padding[1] - padding[3]) / 2 * resolution;
  centerY += (padding[0] - padding[2]) / 2 * resolution;
