...
export default Component.extend({
  ...
  showMinusTwo: safeComputed('page', 'firstPage',
    (page, firstPage) => (page - 2 >= firstPage)),

  showMinusOne: safeComputed('page', 'firstPage',
    (page, firstPage) => (page - 1 >= firstPage)),

  showPlusOne: safeComputed('page', 'lastPage',
    (page, lastPage) => (page + 1 <= lastPage)),

  showPlusTwo: safeComputed('page', 'lastPage',
    (page, lastPage) => (page + 2 <= lastPage)),

  showPlusThree: safeComputed('page', 'lastPage', 'firstPage',
